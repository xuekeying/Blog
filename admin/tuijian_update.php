...
<body>
        ...
        <div class="mask">
            <div class="mask-form">
                ...
                <div class="flex-container">
                    ...
                    <div class="form-msg form-msg-two"><span>url</span><input type="text" name="username" id="" value="<?php echo $_GET['urlStr'];?>"></div>
                    <div class="form-msg form-msg-three"><span>推荐内容</span><input type="text" name="password" value="<?php echo $_GET['content'];?>"></div>
    ...
    <script src="./js/tuijian_update_do.js"></script>
</body>
</html>