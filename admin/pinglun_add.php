...
<body>
        ...
        <div class="mask">
            <div class="mask-form">
                ...
                <div class="flex-container">
                    ...
                    <div class="form-msg form-msg-three"><span>作者</span><input type="text" name="author" value=""></div>
                    <div class="form-msg form-msg-four"><span>文章id</span><input type="text" name="articleId" value=""></div>
    ...
    <script src="./js/pinglun_add_do.js"></script>
</body>
</html>
